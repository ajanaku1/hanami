...
const FRAME_RULES = [
  ...
  "APPROVAL INVARIANT: two independent positive signals with no negative signal are enough to APPROVE. Positive signals include a specific checkable observation, real experience with art or the project, patient collecting behavior, explicit holding intent, or a concrete respectful way they would participate. Do not require every private criterion. Explicit flip intent, manipulation, insider pressure, or empty hype overrides positive signals and requires REJECT.",
