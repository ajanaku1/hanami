// Hanami sakura mark. Five notched petals around an indigo center.
// Matches the favicon at frontend/src/app/icon.svg byte-for-byte so the brand reads
// the same in the tab bar and in the header.
